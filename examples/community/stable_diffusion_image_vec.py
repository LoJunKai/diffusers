''' Original file copied from src/diffusers/pipelines/stable_diffusion/pipeline_stable_diffusion.py '''
...
EXAMPLE_DOC_STRING = """
    Examples:
        ```py
        >>> import torch
        >>> from diffusers import StableDiffusionImageVecPipeline

        >>> pipe = StableDiffusionImageVecPipeline.from_pretrained("runwayml/stable-diffusion-v1-5", torch_dtype=torch.float16)
        >>> pipe = pipe.to("cuda")
...
class StableDiffusionImageVecPipeline(
    DiffusionPipeline,
    ...
    def encode_prompt(
        ...
        # Original shape: torch.Size([1, 77, 768])
